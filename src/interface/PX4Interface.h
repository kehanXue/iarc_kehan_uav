...
namespace vwpp
{
    ...
    public:
        ...
        int8_t publishTarget(const TargetVelXYYawPosZ _target_vel_xy_yaw_pos_z);

        int8_t publishTarget(const TargetPosXYZVelYaw _target_pos_xyz_vel_yaw);
